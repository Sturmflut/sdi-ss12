...
void * IF_NAMESERVER_vtable_6[IF_NAMESERVER_DEFAULT_VTABLE_SIZE] = IF_NAMESERVER_DEFAULT_VTABLE_6;
void * IF_NAMESERVER_vtable_discard[IF_NAMESERVER_DEFAULT_VTABLE_SIZE] = IF_NAMESERVER_DEFAULT_VTABLE_DISCARD;
void ** IF_NAMESERVER_itable[8] = { IF_NAMESERVER_vtable_discard, IF_NAMESERVER_vtable_discard, IF_NAMESERVER_vtable_discard, IF_NAMESERVER_vtable_discard, IF_NAMESERVER_vtable_5, IF_NAMESERVER_vtable_6, IF_NAMESERVER_vtable_discard, IF_NAMESERVER_vtable_discard };
