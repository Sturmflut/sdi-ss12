 ...
 * Mapping     : CORBA C
 * 
 * Generated by IDL4 1.1.0 (roadrunner) on 09/07/2012 17:16
...
{
    printf("[NAMESERVER] Got register for path '%s' from thread %lx\n", path, _caller.raw);
...
{
    printf("[NAMESERVER] Got deregister from thread %lx\n", _caller.raw);
