 ...
 * Mapping     : CORBA C
 * 
 * Generated by IDL4 1.1.0 (roadrunner) on 19/09/2012 20:55
...
void * memoryserver_vtable_11[MEMORYSERVER_DEFAULT_VTABLE_SIZE] = MEMORYSERVER_DEFAULT_VTABLE_11;
void * memoryserver_vtable_discard[MEMORYSERVER_DEFAULT_VTABLE_SIZE] = MEMORYSERVER_DEFAULT_VTABLE_DISCARD;
void ** memoryserver_itable[16] = { memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_11, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard, memoryserver_vtable_discard };
