...
{
  return fileserver_Lookup_impl(_caller, path, remaining, _env);
}
...
{
    return fileserver_get_file_id_impl(_caller, path, _env);
}
...
{
    return fileserver_read_impl(_caller, file_id, offset, count, buf, _env);
}
...
{
    return fileserver_write_impl(_caller, file_id, offset, count, buf, _env);
}
...
{
    return  fileserver_get_file_size_impl(_caller, path, _env);
}
...
{
  return fileserver_get_file_type_impl(_caller, path, _env);
}
...
{
    return fileserver_remove_impl(_caller, file_id, _env);
}
...
{
    return fileserver_mkdir_impl(_caller, path, _env);
}
...
{
    return fileserver_rmdir_impl(_caller, path, _env);
}
...
{
    return fileserver_get_dir_size_impl(_caller, path, _env);
}
