 ...
 * Mapping     : CORBA C
 * 
 * Generated by IDL4 1.1.0 (roadrunner) on 23/08/2012 14:04
...
IDL4_INLINE L4_ThreadId_t  taskserver_create_task_implementation(CORBA_Object  _caller, const path_t  path, idl4_server_environment * _env)
...
void * taskserver_vtable_3[TASKSERVER_DEFAULT_VTABLE_SIZE] = TASKSERVER_DEFAULT_VTABLE_3;
...
void ** taskserver_itable[8] = { taskserver_vtable_discard, taskserver_vtable_discard, taskserver_vtable_discard, taskserver_vtable_3, taskserver_vtable_4, taskserver_vtable_discard, taskserver_vtable_6, taskserver_vtable_discard };
